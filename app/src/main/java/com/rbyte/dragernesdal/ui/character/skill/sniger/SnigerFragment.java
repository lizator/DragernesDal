...
public class SnigerFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        recyclerView = (RecyclerView) root.findViewById(R.id.snigerRecycler);
        ...
        skillViewModel.getSnigerAbilities().observe(getViewLifecycleOwner(), new Observer<ArrayList<AbilityDTO>>() {
            @Override
            ...
            bgThread2.execute(() -> {
                ...
                uiThread.post(() -> {
                    if (res instanceof Result.Success) {
                        ...
                        if (data == null){
                            Log.d("SnigerFragment", "data null");
                        }
