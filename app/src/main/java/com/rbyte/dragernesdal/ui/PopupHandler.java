...
public class PopupHandler {
    ...
    public AlertDialog.Builder getConfirmRemoveInventoryAlert(View thisView, String itemName, DialogInterface.OnClickListener okListener){
        builder.setTitle("Køb Evne!");
        View alertView = LayoutInflater.from(context).inflate(R.layout.popup_confirmation_remove_inventory, (ViewGroup) thisView.getRootView(), false);
        String text = (String) ((TextView) alertView.findViewById(R.id.Alertmsg)).getText();
